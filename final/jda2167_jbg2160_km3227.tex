...
% Since it seems that data augmentation seems to be a fairly separable issue, we 
...
% bad_test_example = 2405
% 
% plt.imshow(xtest[bad_test_example, :, :, :])
% 
% plt.title(CLASS_LABELS[np.asscalar(ytest[bad_test_example])])
