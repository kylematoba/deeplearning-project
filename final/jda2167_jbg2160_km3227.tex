...
\section{Results}
  ...
  \subsection{Class Based Policies}
    ...
    \begin{figure}[h]
    	...
    	\end{center}
    	\caption{During training, an image will have one of the possible transforms applied to it with a random magnitude. A bird image will have a 37\% chance of being flipped left-right, but only a 6\% chance of being rotated.}
